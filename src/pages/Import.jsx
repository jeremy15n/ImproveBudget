      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/60 dark:border-slate-800 p-5">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">All uploads are stored locally so YOU own YOUR data!</p>
          </div>

          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/60 dark:border-slate-800 p-5">
            <div className="flex items-center gap-3 mb-3">
              {/* DARK MODE FIX: Amber Theme */}
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">Our system generates a unique fingerprint for each transaction using date + amount + merchant. Duplicate imports are automatically skipped.</p>
          </div>

          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/60 dark:border-slate-800 p-5">
            <div className="flex items-center gap-3 mb-3">
              {/* DARK MODE FIX: Emerald Theme */}
            ...
            <ul className="text-xs text-slate-500 dark:text-slate-400 space-y-1.5 mt-2">
